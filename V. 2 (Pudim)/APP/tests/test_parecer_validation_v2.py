...
SECTION_TEXTS = {
    ...
    "tese_credito_governanca": "A tese de crédito articula recomendação, fundamentos quantitativos, limitações e mitigadores disponíveis. A indicação de garantia conserva apenas o alcance efetivamente registrado, sem presumir modalidade, cobertura ou exequibilidade. Manifestação do analista e decisão da alçada são posições autônomas, com autoria e fundamentação próprias, e qualquer divergência deve permanecer claramente identificada na trilha de governança.",
        ...
        payload.update(
            {
                ...
                "recomendacoes_monitoramento": [
                    {"texto": "Acompanhar o limitador conforme a governança institucional.", "achado_ids": risks[:1]}
                ],
            }
        )
        return payload
